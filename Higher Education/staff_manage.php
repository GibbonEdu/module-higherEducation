...
if (isActionAccessible($guid, $connection2, '/modules/Higher Education/staff_manage.php') == false) {
    ...
    if ($result->rowCount() < 1) {
        ...
        while ($row = $resultPage->fetch()) {
            ...
            echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/'.$_SESSION[$guid]['module'].'/staff_manage_delete.php&higherEducationStaffID='.$row['higherEducationStaffID']."'><img title='Delete' src='./themes/".$_SESSION[$guid]['gibbonThemeName']."/img/garbage.png'/></a> ";
            echo '</td>';
            echo '</tr>';
        }
        echo '</table>';
