							...
							<td colspan=2>
								...
								if ($resultContributions->rowCount() < 1) {
									...
									while ($rowContributions = $resultContributions->fetch()) {
										...
										echo "<a class='thickbox' href='".$_SESSION[$guid]['absoluteURL'].'/fullscreen.php?q=/modules/'.$_SESSION[$guid]['module'].'/references_manage_edit_contribution_delete.php&higherEducationReferenceComponentID='.$rowContributions['higherEducationReferenceComponentID']."&higherEducationReferenceID=$higherEducationReferenceID&gibbonSchoolYearID=$gibbonSchoolYearID&width=650&height=135'><img title='Delete' src='./themes/".$_SESSION[$guid]['gibbonThemeName']."/img/garbage.png'/></a> ";
