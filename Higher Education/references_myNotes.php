...
if (isActionAccessible($guid, $connection2, "/modules/Higher Education/references_myNotes.php")==FALSE) {
	...
	if ($result->rowCount()!=1) {
		...
		<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/references_myNotesProcess.php" ?>">
			<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
				<tr>
					<td colspan=2> 
						<?php print getEditor($guid,  TRUE, "referenceNotes", $row["referenceNotes"], 25, false, false, false) ?>
					</td>
				</tr>
