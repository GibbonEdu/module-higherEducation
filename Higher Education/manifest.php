...
//Module tables
$moduleTables[0] = "CREATE TABLE `higherEducationMajor` (`higherEducationMajorID` int(6) unsigned zerofill NOT NULL auto_increment, `name` varchar(100) NOT NULL default '', `active` enum('Y','N') NOT NULL default 'Y', PRIMARY KEY  (`higherEducationMajorID`)) ENGINE=InnoDB AUTO_INCREMENT=195 ;";
...
$moduleTables[2] = "CREATE TABLE `higherEducationInstitution` ( `higherEducationInstitutionID` int(6) unsigned zerofill NOT NULL auto_increment, `name` varchar(150) NOT NULL default '', `country` varchar(80) NOT NULL default '', `active` enum('Y','N') NOT NULL default 'Y', PRIMARY KEY  (`higherEducationInstitutionID`)) ENGINE=InnoDB AUTO_INCREMENT=202 ;";
...
$moduleTables[4] = "CREATE TABLE `higherEducationStaff` (`higherEducationStaffID` int(4) unsigned zerofill NOT NULL AUTO_INCREMENT, `gibbonPersonID` int(10) unsigned zerofill NOT NULL, `role` enum('Coordinator','Advisor') NOT NULL, PRIMARY KEY (`higherEducationStaffID`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ;";
$moduleTables[5] = 'CREATE TABLE `higherEducationStudent` (  `higherEducationStudentID` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,  `gibbonPersonID` int(10) unsigned zerofill NOT NULL,  `gibbonPersonIDAdvisor` int(10) unsigned zerofill DEFAULT NULL,  `referenceNotes` text NOT NULL,  PRIMARY KEY (`higherEducationStudentID`)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ;';
