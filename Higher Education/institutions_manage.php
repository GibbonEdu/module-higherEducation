    ...
    if ($role != 'Coordinator') {
        ...
        if ($result->rowCount() < 1) {
            ...
            while ($row = $resultPage->fetch()) {
                ...
                echo "<a class='thickbox' href='".$_SESSION[$guid]['absoluteURL'].'/fullscreen.php?q=/modules/'.$_SESSION[$guid]['module'].'/institutions_manage_delete.php&higherEducationInstitutionID='.$row['higherEducationInstitutionID']."&width=650&height=135'><img title='Delete' src='./themes/".$_SESSION[$guid]['gibbonThemeName']."/img/garbage.png'/></a> ";
                echo '</td>';
                echo '</tr>';
            }
            echo '</table>';
