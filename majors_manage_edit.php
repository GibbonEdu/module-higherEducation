	...
	if ($role!="Coordinator") {
		...
		if ($higherEducationMajorID=="Y") {
			...
			if ($result->rowCount()!=1) {
				...
				$row=$result->fetch() ;
				?>
				<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/majors_manage_editProcess.php?higherEducationMajorID=$higherEducationMajorID" ?>">
